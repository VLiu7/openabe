...
#line 3 "zparser.yy" // lalr1.cc:429
 /*** C/C++ Declarations ***/
...
#line 59 "zparser.tab.cc" // lalr1.cc:429

#include "zparser.tab.hh"

// Second part of user prologue.
#line 96 "zparser.yy" // lalr1.cc:434
...
#line 77 "zparser.tab.cc" // lalr1.cc:434
...
namespace oabe {
#line 172 "zparser.tab.cc" // lalr1.cc:510
  ...
  Parser::yy_destroy_ (const char* yymsg, basic_symbol<Base>& yysym) const
  {
    ...
    {
      case 4: // "string"
#line 89 "zparser.yy" // lalr1.cc:652
        { delete (yysym.value.stringVal); }
#line 405 "zparser.tab.cc" // lalr1.cc:652
        break;

      case 33: // number
#line 92 "zparser.yy" // lalr1.cc:652
        { delete (yysym.value.uInteger); }
#line 411 "zparser.tab.cc" // lalr1.cc:652
        break;

      case 34: // policy
#line 90 "zparser.yy" // lalr1.cc:652
        { delete (yysym.value.treeNode); }
#line 417 "zparser.tab.cc" // lalr1.cc:652
        break;

      case 35: // attrlist
#line 91 "zparser.yy" // lalr1.cc:652
        { delete (yysym.value.oabeAttrList); }
#line 423 "zparser.tab.cc" // lalr1.cc:652
        break;
...
#line 47 "zparser.yy" // lalr1.cc:788
{
    // initialize the initial location object
    yyla.location.begin.filename = yyla.location.end.filename = &driver.streamname;
}

#line 569 "zparser.tab.cc" // lalr1.cc:788
      ...
      try
#endif // YY_EXCEPTIONS
        {
          switch (yyn)
            {
  case 2:
#line 114 "zparser.yy" // lalr1.cc:919
    { driver.set_policy((yystack_[0].value.treeNode)); }
#line 693 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 3:
#line 115 "zparser.yy" // lalr1.cc:919
    { driver.set_attrlist((yystack_[0].value.oabeAttrList)); }
#line 699 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 4:
#line 117 "zparser.yy" // lalr1.cc:919
    {
...
#line 711 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 5:
#line 124 "zparser.yy" // lalr1.cc:919
    { (yylhs.value.uInteger) = create_flexint((yystack_[0].value.uintVal)); }
#line 717 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 6:
#line 126 "zparser.yy" // lalr1.cc:919
    { (yylhs.value.treeNode) = driver.leaf_node(*(yystack_[0].value.stringVal)); delete (yystack_[0].value.stringVal); }
#line 723 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 7:
#line 127 "zparser.yy" // lalr1.cc:919
    { (yylhs.value.treeNode) = driver.kof2_tree(1, (yystack_[2].value.treeNode), (yystack_[0].value.treeNode)); }
#line 729 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 8:
#line 128 "zparser.yy" // lalr1.cc:919
    { (yylhs.value.treeNode) = driver.kof2_tree(2, (yystack_[2].value.treeNode), (yystack_[0].value.treeNode)); }
#line 735 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 9:
#line 129 "zparser.yy" // lalr1.cc:919
...
#line 741 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 10:
#line 130 "zparser.yy" // lalr1.cc:919
...
#line 747 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 11:
#line 131 "zparser.yy" // lalr1.cc:919
...
#line 753 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 12:
#line 132 "zparser.yy" // lalr1.cc:919
...
#line 759 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 13:
#line 133 "zparser.yy" // lalr1.cc:919
...
#line 765 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 14:
#line 134 "zparser.yy" // lalr1.cc:919
    { (yylhs.value.treeNode) = (yystack_[1].value.treeNode); }
#line 771 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 15:
#line 137 "zparser.yy" // lalr1.cc:919
...
#line 779 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 16:
#line 141 "zparser.yy" // lalr1.cc:919
...
#line 787 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 17:
#line 146 "zparser.yy" // lalr1.cc:919
...
#line 796 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 18:
#line 151 "zparser.yy" // lalr1.cc:919
...
#line 805 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 19:
#line 156 "zparser.yy" // lalr1.cc:919
    { std::unique_ptr<OpenABEUInteger> month(oabe::get_month(*(yystack_[3].value.stringVal))); 
...
#line 814 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 20:
#line 161 "zparser.yy" // lalr1.cc:919
    { std::unique_ptr<OpenABEUInteger> month(oabe::get_month(*(yystack_[3].value.stringVal))); 
...
#line 823 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 21:
#line 166 "zparser.yy" // lalr1.cc:919
    { std::unique_ptr<OpenABEUInteger> month(oabe::get_month(*(yystack_[3].value.stringVal))); 
...
#line 832 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 22:
#line 171 "zparser.yy" // lalr1.cc:919
    { std::unique_ptr<OpenABEUInteger> month(oabe::get_month(*(yystack_[3].value.stringVal))); 
...
#line 841 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 23:
#line 176 "zparser.yy" // lalr1.cc:919
    { (yylhs.value.oabeAttrList) = driver.leaf_attr(*(yystack_[0].value.stringVal)); delete (yystack_[0].value.stringVal); }
#line 847 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 24:
#line 177 "zparser.yy" // lalr1.cc:919
    { (yylhs.value.oabeAttrList) = driver.concat_attr((yystack_[0].value.oabeAttrList), nullptr); }
#line 853 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 25:
#line 178 "zparser.yy" // lalr1.cc:919
    { (yylhs.value.oabeAttrList) = driver.concat_attr((yystack_[1].value.oabeAttrList), nullptr); }
#line 859 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 26:
#line 179 "zparser.yy" // lalr1.cc:919
...
#line 865 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 27:
#line 180 "zparser.yy" // lalr1.cc:919
...
#line 871 "zparser.tab.cc" // lalr1.cc:919
    break;

  case 28:
#line 182 "zparser.yy" // lalr1.cc:919
    { std::unique_ptr<OpenABEUInteger> month(oabe::get_month(*(yystack_[3].value.stringVal))); 
...
#line 880 "zparser.tab.cc" // lalr1.cc:919
    break;


#line 884 "zparser.tab.cc" // lalr1.cc:919
            default:
              break;
            }
        }
...
#line 1358 "zparser.tab.cc" // lalr1.cc:1242
#line 192 "zparser.yy" // lalr1.cc:1243
 /*** Additional Code ***/
